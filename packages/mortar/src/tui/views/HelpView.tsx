...
const NAVIGATION: Section = {
  ...
  accent: 'cyan',
  entries: [
    { keys: ['tab', 'shift+tab'], description: 'switch panel (list ↔ logs)' },
    { keys: ['↑', '↓', 'j', 'k'], description: 'list focused: pick service' },
    { keys: ['↑', '↓'], description: 'logs focused: scroll one line' },
    { keys: ['shift+↑', 'shift+↓'], description: 'logs focused: scroll 10 lines' },
    { keys: ['PgUp', 'PgDn'], description: 'logs focused: half a page' },
    { keys: ['g'], description: 'logs: top of buffer' },
    { keys: ['G'], description: 'logs: live tail' },
