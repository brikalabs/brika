...
import { BrixStage, EMOTE_LIBRARY, type EmoteName, EmoteProvider, useEmote } from '@brika/brix';
...
function pickGreeting(): EmoteName {
  const BOOT_EMOTES = Object.keys(EMOTE_LIBRARY) as ReadonlyArray<EmoteName>;
