...
import { showSuccess, showError } from '../../auth-prompts';
    ...
    try {
      ...
      const expiresIn = (await p.select({
        ...
        options: [
          ...
          { value: (7 * 24 * 60 * 60).toString(), label: '7 days' },
          { value: (30 * 24 * 60 * 60).toString(), label: '30 days' },
          { value: (90 * 24 * 60 * 60).toString(), label: '90 days' },
          { value: (365 * 24 * 60 * 60).toString(), label: '1 year' },
        ],
