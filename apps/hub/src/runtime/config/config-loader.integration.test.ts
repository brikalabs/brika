...
// Use tmpdir so ConfigLoader.#findWorkspaceRoot can't walk up to the real
// repo's bun.lock — the test relies on the fallback to `rootDir` for
// `workspace:./path` resolution.
const TEST_DIR = join(tmpdir(), 'brika-config-loader-test');
