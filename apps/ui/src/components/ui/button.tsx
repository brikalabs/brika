...
const buttonVariants = cva(
  "corner-button inline-flex shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-button font-medium text-sm outline-none transition-all focus-visible:ring-themed disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
