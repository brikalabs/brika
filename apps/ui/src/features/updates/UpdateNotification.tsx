...
export function UpdateNotification() {
  ...
  return (
    <>
      <div
        className="fade-in-50 slide-in-from-bottom-2 pointer-events-auto fixed right-4 bottom-4 z-50 flex max-w-sm animate-in flex-col gap-3 rounded-toast border border-border/60 bg-card/95 p-4 shadow-toast backdrop-blur-md duration-300"
        role="status"
      >
        <div className="flex items-start gap-3">
          ...
          <button
            ...
            className="flex size-6 shrink-0 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-foreground/[0.04] hover:text-foreground"
