...
function WindowsIcon({ className }: Readonly<{ className?: string }>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
...
function AndroidIcon({ className }: Readonly<{ className?: string }>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
...
function getOsIcon(os: string): React.ComponentType<{ className?: string }> {
  switch (os) {
    case 'macOS':
    case 'iOS':
      return AppleIcon;
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1">
            <span className="text-sm text-muted-foreground">{t('auth:sessions.userAgent')}</span>
  ...
  return (
    ...
    >
      ...
      <div className="flex shrink-0 items-center gap-1">
        <Button variant="ghost" size="icon" className="size-8 text-muted-foreground" onClick={onDetails}>
...
export function SessionsSection() {
  ...
  function renderSessions() {
    ...
    if (sessions.length === 0) {
      return <p className="text-sm text-muted-foreground">{t('auth:sessions.noSessions')}</p>;
    }
    return (
      <div className="space-y-3">
