...
function hsl(h: number, s: number, l: number): string {
  ...
  return rgbToHex(
    hslToRgb({ h: hh, s: Math.min(1, Math.max(0, s)), l: Math.min(1, Math.max(0, l)) })
  );
}
...
interface ModeConfig {
  ...
  containers: {
    ...
    onPrimary: ContainerSlot;
    secondary: ContainerSlot;
    onSecondary: ContainerSlot;
    accent: ContainerSlot;
    onAccent: ContainerSlot;
    success: SemanticSlot;
    onSuccess: SemanticSlot;
    warning: SemanticSlot;
    onWarning: SemanticSlot;
    info: SemanticSlot;
    onInfo: SemanticSlot;
    destruct: SemanticSlot;
    onDestruct: SemanticSlot;
  };
...
const LIGHT: ModeConfig = {
  ...
  neutralL: {
    ...
    statusIdle: 0.62,
    sidebarFg: 0.1,
    sidebarAccentFg: 0.12,
  },
  semantic: {
    s: [0.6, 0.82, 0.75, 0.82],
    l: [0.42, 0.47, 0.5, 0.52],
    fg: ['#ffffff', '#0a0a0a', '#ffffff', '#ffffff'],
  },
  data: { s: 0.7, l: 0.5 },
  sidebar: { useNeutral: true, bgL: 0.97, accentL: 0.92, borderL: 0.88 },
  outline: { base: 0.88, variant: 0.92 },
  containers: {
    primary: { sMult: 0.5, l: 0.9 },
    onPrimary: { sMult: 0.8, l: 0.2 },
    secondary: { sMult: 0.4, l: 0.92 },
    onSecondary: { sMult: 0.8, l: 0.2 },
    accent: { sMult: 0.45, l: 0.91 },
    onAccent: { sMult: 0.8, l: 0.2 },
    success: { s: 0.55, l: 0.9 },
    onSuccess: { s: 0.6, l: 0.18 },
    warning: { s: 0.7, l: 0.9 },
    onWarning: { s: 0.8, l: 0.18 },
    info: { s: 0.65, l: 0.9 },
    onInfo: { s: 0.7, l: 0.18 },
    destruct: { s: 0.7, l: 0.9 },
    onDestruct: { s: 0.8, l: 0.18 },
  },
...
const DARK: ModeConfig = {
  ...
  neutralL: {
    ...
    statusIdle: 0.5,
    sidebarFg: 0.9,
    sidebarAccentFg: 0.88,
  },
  semantic: {
    s: [0.6, 0.8, 0.75, 0.8],
    l: [0.65, 0.62, 0.68, 0.68],
    fg: ['#0a0a0a', '#0a0a0a', '#0a0a0a', '#0a0a0a'],
  },
  data: { s: 0.65, l: 0.65 },
  sidebar: { useNeutral: false, bgL: 0.09, accentL: 0.18, borderL: 0.2 },
  outline: { base: 0.22, variant: 0.18 },
  containers: {
    primary: { sMult: 0.4, l: 0.22 },
    onPrimary: { sMult: 0.7, l: 0.88 },
    secondary: { sMult: 0.35, l: 0.2 },
    onSecondary: { sMult: 0.65, l: 0.88 },
    accent: { sMult: 0.38, l: 0.21 },
    onAccent: { sMult: 0.65, l: 0.88 },
    success: { s: 0.5, l: 0.22 },
    onSuccess: { s: 0.6, l: 0.88 },
    warning: { s: 0.6, l: 0.2 },
    onWarning: { s: 0.75, l: 0.88 },
    info: { s: 0.55, l: 0.22 },
    onInfo: { s: 0.65, l: 0.88 },
    destruct: { s: 0.6, l: 0.22 },
    onDestruct: { s: 0.75, l: 0.88 },
  },
