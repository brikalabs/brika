 ...
 * animation on the left; runtime metadata fills the right column.
 *
 *      ╭───╮     Brika Console
 *      │^◡^│
 *      ╰───╯     version    0.1.0
    ...
    <Box>
      ...
      <Box flexDirection="column" flexGrow={1} marginLeft={2}>
        ...
        <Box marginTop={1} flexDirection="column">
          ...
          {build.buildTime && (
            <InfoLine label="built" color="white">
              <Text>{formatBuildTime(build.buildTime)}</Text>
            </InfoLine>
          )}
